...
var cleanMap = function () { return __awaiter(void 0, void 0, void 0, function () {
    var mapRaw, _a, _b, _i, featureIdx, country;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                mapRaw = JSON.parse(fs_1.default.readFileSync(path_1.default.join(__dirname, "../../public/map_translated.geo.json")));
                _a = [];
                for (_b in mapRaw.features)
                    _a.push(_b);
                _i = 0;
                _c.label = 1;
            case 1:
            ...
            case 3:
                ...
                return [3 /*break*/, 1];
            case 4:
                fs_1.default.writeFileSync(path_1.default.join(__dirname, "../../public/map_translated.geo.json"), JSON.stringify(mapRaw));
                return [2 /*return*/];
        }
    });
}); };
exports.default = cleanMap;
//# sourceMappingURL=cleanMap.js.map